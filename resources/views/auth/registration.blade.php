                        ...
                        <form action="" id="form">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="password" id="form_cpassword" name="password_confirmation" class="form-control cpassword" style="margin-bottom: 3%;" >
                                    <span class="text-danger" id="cpasswordErrorMsg"></span>
                                </div>
                            </div>
                            <div class="form-group">
